...
export MODEL_BUCKET_PROD="stg-mlartifact-s3-store-sales-predictions"
export PREDICTIONS_STREAM_NAME="stg_sales_predictions-store-sales-predictions"
export LAMBDA_FUNCTION="stg_prediction_lambda_store-sales-predictions"
